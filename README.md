...
4. **Cache structure**
   ...
   ## Module invocation relationships

   <img src="./img/3.png" alt="img" style="zoom:150%;" />

   

   ## Key function algorithm design

1. **DiskINode allocation algorithm: FileSystem::IAlloc()** 
...
2. **DiskINode deallocation algorithm: FileSystem::IFree()** 
...
3. **Free disk block allocation algorithm: FileSystem::Alloc()** 
...
4. **Free disk block deallocation algorithm: FileSystem::Free()**
...
5. **Directory search algorithm: FileManager::NameI()** 
...
6. **File index to file data block mapping algorithm: Inode::Bmap()** 
...
7. **High-speed cache allocation algorithm**
...
8. **High-speed cache eviction algorithm**
